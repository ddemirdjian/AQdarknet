...
void save_detections(FILE* fp, image im, int num, float thresh, box *boxes, float **probs, char **names, image **alphabet, int classes)
{
    int i;
    ...
    for(i = 0; i < num; ++i){
        ...
        if(prob > thresh){
            ...
            fprintf(fp, "%f %d %d %d %d %d ", prob, class, left, top, right, bot);
        }
    }
    fprintf(fp, "\n");
}
...
void test_detector(char *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh)
{
    ...
    //    if(filename){
     ...
     //   }
        ...
        save_detections(fp, im, l.w*l.h*l.n, thresh, boxes, probs, names, alphabet, l.classes);
